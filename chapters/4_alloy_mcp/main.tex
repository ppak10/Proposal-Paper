...
providers include LangChain and LlamaIndex. This work utilizes the Model Context
Protocol (MCP) \cite{anthropic_introducing_2024} as the library for creating and
exposing tools for the LLM that allow seamless integration into any client with
an MCP interface.
...
\texttt{additive-manufacturing} can then utilize for process map generation.
