...
\cite{chaudhari_modular_2025, chandrasekhar_automating_2025}. In these tasks,
...
chaudhari_modular_2025, ock_large_2025}. The next course of action often
...
The Model Context Protocol (MCP) is a standard introduced by Anthropic
\cite{anthropic_anthropic_2025} which provides guidelines for used functionality
such as tool calling and resource querying; Particularly suitable for agentic
tasks \cite{anthropic_introducing_2024, ehtesham_survey_2025, hou_model_2025}.
Along with these features, MCP is compatible with the wider ecosystem of LLM
providers with integrations in Software Development Kits (SDKs) developed by
Anthropic, OpenAI, Google \cite{hamsa_buvaraghan_mcp_2025}, and others
\cite{hou_model_2025}.
