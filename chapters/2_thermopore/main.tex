...
Fig. \ref{fig:thermopore_main}, the general architecture of this framework consists of two
separate deep learning models (Fig. \ref{fig:thermopore_main}d and \ref{fig:thermopore_main}e) which
extract embeddings from a sequence of \textit{in-situ} thermal images (Fig.
\ref{fig:thermopore_main}c). These embeddings correspond to the quantitative and localized
information of pores obtained from the segmented computed tomography data (Fig.
\ref{fig:thermopore_main}b). The predictions from these models indicate the degree of
...
\begin{figure}[bt]
  ...
  \caption{
    A sequence of 200 thermal pyrometry images (\ref{fig:thermopore_main}c) providing
    absolute temperature values of the build plate taken \textit{in-situ}
    (\ref{fig:thermopore_main}a) are provided as input data for models for pore
    quantification (\ref{fig:thermopore_main}d) and pore localization (\ref{fig:thermopore_main}e).
